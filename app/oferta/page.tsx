      ...
      <div className="relative z-10 flex min-h-screen flex-col">
        ...
        <main className="flex-1 px-6 py-20 sm:px-8 sm:py-28">
          <div className="mx-auto max-w-2xl">
            ...
            <p className="mt-6 text-black/55">
            ...
            <Link
              href="/"
              className="mt-10 inline-block text-sm font-medium text-black/70 transition-all duration-200 hover:scale-105 hover:text-black"
            >
